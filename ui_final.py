...
"}")
        ...
        self.rightframe.setGeometry(QRect(1420, 100, 491, 951))
...
"")
        ...
        self.start.setGeometry(QRect(20, 760, 89, 81))
        ...
        self.altitude.setGeometry(QRect(360, 110, 111, 31))
        ...
        self.compass.setGeometry(QRect(150, 120, 191, 191))
        ...
        self.direction.setGeometry(QRect(90, 420, 61, 31))
        ...
        self.direction1.setGeometry(QRect(170, 420, 151, 31))
...
"}")
        ...
        self.map.setGeometry(QRect(50, 90, 1391, 971))
...
"}")
    ...
    def retranslateUi(self, finale):
        ...
        self.ovl1.setText(QCoreApplication.translate("finale", u"<html><head/><body><p>50.6</p></body></html>", None))
        self.ovl2.setText(QCoreApplication.translate("finale", u"<html><head/><body><p>50.2</p><p><br/></p></body></html>", None))
        self.ovl3.setText(QCoreApplication.translate("finale", u"<html><head/><body><p>50</p><p><br/></p></body></html>", None))
        self.ovl4.setText(QCoreApplication.translate("finale", u"<html><head/><body><p>49.6</p></body></html>", None))
        ...
        self.ov1.setText(QCoreApplication.translate("finale", u"<html><head/><body><p>3450</p><p><br/></p></body></html>", None))
        self.ov2.setText(QCoreApplication.translate("finale", u"<html><head/><body><p>3350</p></body></html>", None))
        self.ov3.setText(QCoreApplication.translate("finale", u"<html><head/><body><p>3250<br/></p></body></html>", None))
        self.ov4.setText(QCoreApplication.translate("finale", u"<html><head/><body><p>3150</p></body></html>", None))
