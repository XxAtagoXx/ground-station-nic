...
"")
        ...
        self.d3_value.setGeometry(QtCore.QRect(180, 630, 391, 81))
...
"}")
        ...
        self.map.setGeometry(QtCore.QRect(50, 90, 1261, 971))
        ...
        self.battery = QtWidgets.QProgressBar(self.back)
        self.battery.setGeometry(QtCore.QRect(1310, 90, 20, 971))
        ...
        self.icon = QtWidgets.QWidget(self.back)
        self.icon.setGeometry(QtCore.QRect(50, 40, 121, 51))
