...
"")
        ...
        self.ovl1 = QtWidgets.QLabel(self.rightframe)
        self.ovl1.setGeometry(QtCore.QRect(70, 150, 61, 31))
        self.ovl1.setWordWrap(False)
        self.ovl1.setObjectName("ovl1")
        self.ovl2 = QtWidgets.QLabel(self.rightframe)
        self.ovl2.setGeometry(QtCore.QRect(70, 220, 61, 31))
        self.ovl2.setWordWrap(False)
        self.ovl2.setObjectName("ovl2")
        self.ovl3 = QtWidgets.QLabel(self.rightframe)
        self.ovl3.setGeometry(QtCore.QRect(70, 290, 61, 31))
        self.ovl3.setWordWrap(False)
        self.ovl3.setObjectName("ovl3")
        self.ovl4 = QtWidgets.QLabel(self.rightframe)
        self.ovl4.setGeometry(QtCore.QRect(70, 360, 61, 31))
...
"}")
    ...
    def retranslateUi(self, finale):
        ...
        self.ovl1.setText(_translate("finale", "<html><head/><body><p>50.6</p></body></html>"))
        self.ovl2.setText(_translate("finale", "<html><head/><body><p>50.2</p><p><br/></p></body></html>"))
        self.ovl3.setText(_translate("finale", "<html><head/><body><p>50</p><p><br/></p></body></html>"))
        self.ovl4.setText(_translate("finale", "<html><head/><body><p>49.6</p></body></html>"))
